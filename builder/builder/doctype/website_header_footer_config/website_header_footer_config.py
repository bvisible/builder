#//// Neoffice — added file (no upstream equivalent): the site chrome Single: header, footer, menu,
#//// theme tokens. Neoffice DocType, no upstream counterpart. First commit 5233329b 2026-02-02.
