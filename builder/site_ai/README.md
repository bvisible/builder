<!-- //// Neoffice — added file (no upstream equivalent): how builder/ai is laid out and how a page gets
     //// generated. builder/site_ai/** = the Neoffice AI site generator; frappe/builder ships no such module.
...
```python
from builder.site_ai import PageGenerator, generate_page
...
```python
from builder.site_ai.generators import SectionGenerator
...
```python
from builder.site_ai.generators import HeaderGenerator, FooterGenerator
...
```python
from builder.site_ai.config import AIConfig, get_ai_settings
...
```python
from builder.site_ai.design_system import get_theme, list_themes
...
from builder.site_ai.templates.sections import build_hero_section
...
```python
from builder.site_ai.validators import BlockValidator, AutoFixer, validate_block
...
1. Create `builder/site_ai/design_system/themes/mytheme.py`:
...
```python
from builder.site_ai.design_system.themes.mytheme import MYTHEME_THEME
