# //// Neoffice — added package (no upstream equivalent): our site-level AI engine (site brief,
# //// design intelligence, multi-page generation, images, validators). It lived in builder/ai until
# //// 2026-09-07; upstream v1.33 now owns builder/ai (the Bob agent), so ours moved here to keep
# //// the two packages from shadowing each other (their prompts.py vs our prompts/ package).
# //// Neoffice — added file (no upstream equivalent): package root of the AI generator; lazy re-exports
# //// so importing builder.site_ai stays cheap. builder/site_ai/** = the Neoffice AI site generator;
...
# generators, validators. Every one of them imports `builder.site_ai.logging`,
...
#     initialized module 'builder.site_ai.providers' (circular import)
#
...
_EXPORTS = {
	"AIConfig": "builder.site_ai.config",
	"get_ai_settings": "builder.site_ai.config",
	"get_provider": "builder.site_ai.providers",
	"PageGenerator": "builder.site_ai.generators.page_generator",
	"generate_page": "builder.site_ai.generators.page_generator",
	"BlockValidator": "builder.site_ai.validators",
	"get_theme": "builder.site_ai.design_system",
	"list_themes": "builder.site_ai.design_system",
	"DESIGN_TOKENS": "builder.site_ai.design_system",
	"ai_log": "builder.site_ai.logging",
	"get_log_path": "builder.site_ai.logging",
}
