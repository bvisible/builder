#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# //// Neoffice — added file (no upstream equivalent): BM25 search engine over the design CSVs (vendored,
# //// stdlib only). builder/site_ai/design_data/** is VENDORED verbatim from
