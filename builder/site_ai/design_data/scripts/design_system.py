#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# //// Neoffice — added file (no upstream equivalent): design-system generator over the search results
# //// (vendored). builder/site_ai/design_data/** is VENDORED verbatim from
