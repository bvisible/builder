...
# //// business, same tone as the brief. builder/site_ai/** = the Neoffice AI site generator; frappe/builder
...
from builder.site_ai.schemas.article import GeneratedArticle
...
def request_cover(article, blog_post_name: str) -> str | None:
	...
	try:
		return frappe.enqueue(
			"builder.site_ai.generators.article_generator.cover_job",
			queue="long",
