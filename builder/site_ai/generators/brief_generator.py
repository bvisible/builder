...
# //// reused by every page. builder/site_ai/** = the Neoffice AI site generator; frappe/builder ships no such
...
Return ONLY the JSON object, no markdown code blocks."""
        ...
        from builder.site_ai.design_intelligence import get_design_candidates
