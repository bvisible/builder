...
# //// ComfyUI (Olares One), server-side only. builder/site_ai/** = the Neoffice AI site generator;
...
def _file_bytes(file_url: str) -> bytes:
    from builder.site_ai.providers.base import BaseProvider  # reuse the resolver
