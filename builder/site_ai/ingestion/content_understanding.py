...
# //// into Builder Content Asset. builder/site_ai/** = the Neoffice AI site generator; frappe/builder ships
...
from builder.site_ai.schemas.content_asset import ImageUnderstanding, DocumentUnderstanding
...
def ingest_content_assets(session_id: str, files, company: str = None) -> dict:
    ...
    frappe.enqueue(
        "builder.site_ai.ingestion.content_understanding.understand_assets_batch",
        queue="long",
        timeout=1800,
        asset_names=names,
