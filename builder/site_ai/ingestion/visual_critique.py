...
# //// page and lists visible defects. builder/site_ai/** = the Neoffice AI site generator; frappe/builder
...
from builder.site_ai.schemas.page_critique import PageCritique
