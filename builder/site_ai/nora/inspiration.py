...
# //// Neoffice ▼▼▼ — the brief painted a B2C storefront's header in the rose of its wordmark and the wordmark vanished; this guard moves a header background close to a dominant logo colour to the site's background token, or to white when that is a logo colour too (925e2366 "fix(nora): the header never wears one of the logo's own colours")
...
def header_off_logo_palette(config, logo_image: str | None, palette: dict, prefix: str) -> str | None:
    ...
    a B2C storefront the rose of its wordmark and the wordmark vanished (2026-09-09). The
