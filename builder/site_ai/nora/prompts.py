...
- NO COLOUR is a direction, not an omission: "black and white", "no colour", "neutrals only", "less is more" all mean palette_mode='monochrome'. Do not answer it with a colour picker, and do not take an accent from their logo — a logo may be the only coloured thing on a black-and-white site.
