...
4. The logo, the inspirations and the client's photographs. present_ui with ui=[{{kind:'upload', label:'Logo'}}, {{kind:'input', label:'Sites you like (links)'}}, {{kind:'upload', label:'Pictures you like'}}, {{kind:'upload', label:'Your own photos for the site'}}, {{kind:'actions', buttons:[{{label:'Continue'}}, {{label:'Skip', variant:'secondary'}}]}}]. The links become inspiration_urls, ONE PER SITE and ALL of them (up to eight: never keep a shortlist of what the user named). Pictures they LIKE become inspiration_images; pictures that are THEIRS, of their business, their products, their premises, become photos — these are placed in the pages, so ask for them whenever the site is meant to show real photography. {profiles_line(page_id)}
