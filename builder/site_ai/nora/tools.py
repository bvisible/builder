...
generate_site = Tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "photos": {"type": "array", "items": {"type": "string"}, "description": "The client's OWN photographs, to be placed in the pages (site file URLs, up to 40). Each is read for what it shows, its shape and its quality, then laid into the matching image slots; only the slots no photo fits are drawn. Send everything the client supplied. A rebuild in the same conversation with no list at hand may leave it out: the build then reuses every photograph this conversation already took in."},
