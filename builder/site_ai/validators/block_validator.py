...
# //// rejecting the generation. builder/site_ai/** = the Neoffice AI site generator; frappe/builder ships no
...
class BlockValidator:
    ...
    # //// input (builder/site_ai/utils.as_untrusted_source) asks the model to behave; this is the
