...
def get_boot() -> dict:
	...
	return {
		...
		"telemetry_pulse": _has_pulse(),
	}


def _has_pulse() -> bool:
	# find_spec raises on a v15 bench, where frappe.utils.telemetry is a module, not a
	# package (the first deploy of the flag answered 500 on every Studio page)
